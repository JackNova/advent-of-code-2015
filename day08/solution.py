...
# strings. For example, C, JavaScript, Perl, Python, and even PHP handle special characters in very similar ways.
...
# characters and a single, escaped quote character, for a total of 7 characters in the string data.
...
# number of characters in memory for string values (0 + 3 + 7 + 1 = 11) is 23 - 11 = 12.
...
# as a new string and find the number of characters of the new encoded representation,
